...
void btCompoundCollisionAlgorithm::preallocateChildAlgorithms(const btCollisionObjectWrapper* body0Wrap, const btCollisionObjectWrapper* body1Wrap)
{
	...
	for (i = 0; i < numChildren; i++)
	{
		...
		else
		{
			...
			btCollisionObjectWrapper childWrap(colObjWrap, childShape, colObjWrap->getCollisionObject(), colObjWrap->getWorldTransform(), -1, i,colObjWrap->getVoxelInfo());  //wrong child trans, but unused (hopefully)
...
public:
	...
	void ProcessChildShape(const btCollisionShape* childShape, int index)
	{
		...
		{
			btCollisionObjectWrapper compoundWrap(this->m_compoundColObjWrap, childShape, m_compoundColObjWrap->getCollisionObject(), newChildWorldTrans, childTrans, -1, index,m_compoundColObjWrap->getVoxelInfo());
